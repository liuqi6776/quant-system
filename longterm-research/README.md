...
2. **True Outperformance**: The Strategy outperforms the **CSI 1000 Index** (Cagr 1.17%, Sharpe 0.17) by a massive **+11.25% annual excess return (CAGR)** and reduces the Max Drawdown from **-46.22%** to **-28.03%**. This proves that the strategy's return is driven by high-quality selection alpha and is not just a small-cap beta exposure.
